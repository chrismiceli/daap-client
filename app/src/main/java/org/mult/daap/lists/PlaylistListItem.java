 ...
 */
public class PlaylistListItem extends AbstractFlexibleItem<PlaylistListItem.MyViewHolder> {
    private final PlaylistEntity playlist;

    public PlaylistListItem(PlaylistEntity playlist) {
    ...
    public boolean equals(Object inObject) {
        if (inObject instanceof PlaylistListItem) {
            PlaylistListItem inItem = (PlaylistListItem) inObject;
    ...
    public void bindViewHolder(FlexibleAdapter<IFlexible> adapter, MyViewHolder holder,
        ...
        holder.label.setText(this.playlist.getName());
